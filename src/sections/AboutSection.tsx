  ...
  return (
    <section id="about" className="py-16 px-4 sm:px-6 lg:px-8 scroll-mt-20">
      <div className="max-w-4xl mx-auto">
        <h2 role="heading" className="text-4xl font-bold text-center text-slate-900 mb-8">About</h2>
        <div role="article" className="bg-white p-8 rounded-lg shadow-sm">
          <p role="paragraph" className="text-lg text-slate-700 mb-4">
          ...
          <p role="paragraph" className="text-lg text-slate-700">
