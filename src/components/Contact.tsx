    ...
    <Dialog.Root open={contactDialogOpen} onOpenChange={setContactDialogOpen}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-lg p-6 w-full max-w-md shadow-xl">
          <Dialog.Title className="text-2xl font-bold mb-4">{dialogTitle}</Dialog.Title>
          ...
          <Dialog.Close asChild>
            <button className="mt-6 w-full bg-slate-100 text-slate-900 px-4 py-2 rounded-lg hover:bg-slate-200 transition-colors">
              Close
            </button>
          </Dialog.Close>
        </Dialog.Content>
